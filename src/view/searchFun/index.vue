<template>
  <div class="course-index w">
    ...
    <div class="most-new-hot w container">
      ...
      <span
        class="f-l"
        :class="{ active: filtStatus == 2 }"
        @click="filtrate(2)"
      >综合区域</span
      >
      <span
        class="f-l"
        :class="{ active: filtStatus == 3 }"
        @click="filtrate(3)"
      >专家讲座</span
      >
    </div>
...
export default {
  ...
  created() {
    this.searchParams = this.$route.query.param
    this.loadData();
  },
  methods: {
    filtrate(type) {
    ...
    loadData() {
      ...
      switch (this.filtStatus) {
        ...
        case 1:
          ...
          break;
        case 2:
          this.searchComprehensiveArea();
          break;
        case 3:
          this.searchExpertLecture();
          break;
        default:
          break;
      }
    ...
    searchTeacher() {
      this.$post("cms-web/review/video/like/select/api?curPage=" + this.currentPage + "&pageSize=" + this.pageSize, {
        leibie: "gongzuofang",
